...
class HomeView(ListView):
	...
	def get_context_data(self, *args, **kwargs):
		...
		highlighted_post = Post.objects.filter(post_highlighted=True)[0:1]
		single_posts = Post.objects.all().order_by('-post_date')[0:3]
		single_posts2 = Post.objects.all().order_by('-post_date')[1:3]
		single_posts3 = Post.objects.all().order_by('-post_date')[2:4]
		single_posts4 = Post.objects.all().order_by('-post_date')[3:6]
		...
		single_posts6 = Post.objects.filter(category= 'Tv Shows').all().order_by('-post_date')[0:3]
		...
		single_posts15 = Post.objects.filter(category= 'Africa News').all().order_by('-post_date')[4:4]
		...
		single_posts18= Post.objects.filter(category= 'World Topic').all().order_by('-post_date')[2:4]
		single_posts19 = Post.objects.filter(category= 'World Topic').all().order_by('-post_date')[3:4]
		single_posts20 = Post.objects.filter(category= 'World Topic').all().order_by('-post_date')[4:4]
